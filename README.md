🧩 TEAM CHARTER - Survey Core
📘 Project Info
Project: Kotlin Challenge
Team: Survey Core
Motto: Teamwork, Creativity, and Growth
https://github.com/raghad-abbas/survey-core/blob/main/WhatsApp%20Image%202025-11-12%20at%2011.56.43_405fe030.jpg
...
Code Reviewer Reviews code for quality, readability, and adherence to standards. Provides constructive feedback and ensures clean, maintainable code.

Documentation Lead Writes and maintains technical and user documentation. Ensures clarity, accuracy, and updates across all project stages.
...
Our mission is to grow together through learning, creativity, and consistency.

🎯 Team Goals (by :Raghad Abbas)
Developing team members' Kotlin skills.
Fostering a spirit of teamwork.
Producing a professional software project that reflects the team's creativity.
...
Follow Kotlin best practices, including proper use of val vs var, null safety, and concise syntax.
Apply consistent indentation (4 spaces) and spacing rules.
...
• Code Quality and Clean Practices We commit to writing clean, readable, and maintainable code.

• Continuous Learning We learn from each other and accept feedback to improve the team’s overall skills.

• Respect and Responsibility We respect everyone’s opinions and take responsibility for our tasks.

• Problem Solving Mindset We focus on finding practical and efficient solutions to challenges

🕒 Charter Review
This document will be reviewed and updated monthly or whenever major changes occur.

🚀 Team Survey Core believes that success is built on teamwork, responsibility, and continuous growth.
